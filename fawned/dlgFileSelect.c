/*
  ...
  A file selection dialog originally for the graphical user interface
  of Hatari, now used in Fawned.
*/
const char DlgFileSelect_fileid[] = "SDLGui dlgFileSelect.c : " __DATE__ " " __TIME__;
 ...
 */
char* SDLGui_FileSelect(const char *path_and_name, char **zip_path, int bAllowNew)
{
